...
static const struct wl_message zwlr_output_manager_v1_requests[] = {
	{ "create_configuration", "nu", types + 3 },
	{ "stop", "", types + 0 },
};
...
static const struct wl_message zwlr_output_head_v1_events[] = {
	...
	{ "physical_size", "ii", types + 0 },
	{ "mode", "n", types + 6 },
	{ "enabled", "i", types + 0 },
	{ "current_mode", "o", types + 7 },
	{ "position", "ii", types + 0 },
	{ "transform", "i", types + 0 },
	{ "scale", "f", types + 0 },
	{ "finished", "", types + 0 },
...
static const struct wl_message zwlr_output_configuration_v1_requests[] = {
	{ "enable_head", "no", types + 8 },
	{ "disable_head", "o", types + 10 },
	{ "apply", "", types + 0 },
	{ "test", "", types + 0 },
	{ "destroy", "", types + 0 },
};
...
static const struct wl_message zwlr_output_configuration_head_v1_requests[] = {
	{ "set_mode", "o", types + 11 },
	{ "set_custom_mode", "iii", types + 0 },
	{ "set_position", "ii", types + 0 },
	{ "set_transform", "i", types + 0 },
	{ "set_scale", "f", types + 0 },
};
